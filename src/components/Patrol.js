      ...
      <div className="text-center">
        ...
        <div className={css.contact}>
          ...
          <div className={css.searchBox}>
            ...
            <If cond={!currentEncounter}>
              {patrol.searching && <div>Searching...</div>}
            </If>
        ...
        <div className="offset-2 col-8" style={{ height: "4em" }}>
          <button
            ...
            onClick={patrol.newEncounter}
            disabled={
              patrol.searching || currentTravelBox.weather.type === "storm"
            }
          >
            Roll for Encounter
          </button>
        ...
        <div className="offset-2 col-8" style={{ height: "4em" }}>
          <button
            ...
            onClick={patrol.moveToNextTravelBox}
          >
      ...
      <div className="text-center">
        ...
        <div className="text-center row">
          <div className={css.button + " offset-2 col-8"}>
            <button
              className="btn btn-primary btn-block"
              onClick={patrol.clearCurrentEncounter}
            >
              Continue Patrol
            </button>
          </div>
