...
export default class Patrol {
  ...
  @computed get SJRadarAvailable() {
    if (this.startYear > 1942) return true
  ...
  beginPatrol = () => {
    ...
    this.assignment = PatrolAssignment.CreateAssignment(
      this.base,
      this.startDate
    )
  ...
  abort = () => {
    ...
    this.moveToTravelBox(
      this.assignment.travelBoxes[this.assignment.travelBoxes.length - 2]
    )
  }
